...
- [Google 利用「超音波」來讓Nest 裝置知道使用者是否在附近 - Engadget 中文版](http://chinese.engadget.com/2019/10/15/google-nest-ultrasound-sensing-hands-on-hub-max-hub-mini/ "Google 利用「超音波」來讓Nest 裝置知道使用者是否在附近 - Engadget 中文版") 191015 2310
